...
const string CBwaveODE::COMPONENT_NAMES[] = {
    ...
    "rRRx", "rRRy", "rRRz", "vRRx", "vRRy", "vRRz", "E_Nrad", "Jx_Nrad", "Jy_Nrad", "Jz_Nrad", 
    ...
    "rPNSOx", "rPNSOy", "rPNSOz", "vPNSOx", "vPNSOy", "vPNSOz",
    "r2PNSOx", "r2PNSOy", "r2PNSOz", "v2PNSOx", "v2PNSOy", "v2PNSOz","E_PNSOrad", "E_25PNrad",
...
// Helper function to split string by delimiter (replaces boost::split)
...
void set_checkpoint_value(string inputstring) {
   ...
   split_string(inputstring, keyvaluepair, "=");
